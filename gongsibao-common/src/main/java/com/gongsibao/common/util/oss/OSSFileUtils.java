...
public class OSSFileUtils {
    ...
    public final static String BUCKET_NAME_PRIVATE = "gongsibao-img-private";
//    public final static String BUCKET_NAME = "gongsibao-img-public";
...
//    private final static String accessKeySecret = "NsocI4ld0AGCiuNQfwXLUcOUYfW9vN";
    ...
    public static String uploadFile(String folder, MultipartFile file) {
        ...
        try {
            ...
            return uploadFile(BUCKET_NAME, folder, input, getExtName(file.getName()), file.getSize(), null);
        } catch (IOException e) {
            e.printStackTrace();
        }
        return "";
